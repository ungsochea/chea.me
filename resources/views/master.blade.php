...
<head>
        <title>UNG SOCHEA - Personal </title>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="description" content="UNG SOCHEA /resume template for professional and personal website." />
        ...
        <meta name="developer" content="UNG SOCHEA">
                    ...
                    <div class="row xs-column-reverse section-separator vertical-middle-content home-padding">
                        <div class="col-sm-6">
                            <div class="mh-header-info">
                                ...
                                <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">UNG Sochea</h2>
                                <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">Web and App Developer</h4>
                                
                                <ul>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i class="fa fa-envelope"></i><a href="mailto:">sochea.ung@email.com</a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s"><i class="fa fa-phone"></i><a href="callto:">+855 87 914 911 | +855 99 666 432 | +855 66 666 360</a></li>
                                    <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i class="fa fa-map-marker"></i><address>Phnom Penh, Cambodia</address></li>
                                </ul>
                                
                                <ul class="social-icon wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                    <li><a href="https://www.facebook.com/socheahost"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/ungsochea/"><i class="fa fa-linkedin"></i></a></li>
                                    <li><a href="https://www.instagram.com/ungsochea/"><i class="fa fa-instagram"></i></a></li>
                        ...
                        <div class="col-sm-6">
                            <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                <div class="img-border">
                                    <img src="assets/images/chea.png" alt=""  class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
